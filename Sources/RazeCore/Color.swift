...
extension RazeCore {
    ...
    public class Color {
        ...
        /// Allows you co convert a 6 digit hexadecimal string into UIColor instance
        /// - Warning: Tht "#" symbol is stripped from the beginning of the string submitted here.
        /// - Parameters:
        ///   - hexString: A6-digit hexadecimal string. Use 6 digits rather than 8, and add the accompanying alpha value in the second parameter
